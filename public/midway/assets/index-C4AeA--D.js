...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dr,depthTest:!1,depthWrite:!1})}function Gd(){return new xr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:yu(),fragmentShader:`
		...
		`,blending:dr,depthTest:!1,depthWrite:!1})}function Vd(){return new xr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yu(),fragmentShader:`
...
`].filter(pa).join(`
`)),a=Lh(a),a=Qd(a,t),a=ef(a,t),o=Lh(o),o=Qd(o,t),o=ef(o,t),a=tf(a),o=tf(o),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
